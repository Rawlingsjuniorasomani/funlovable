...
import { FileText, Video, Download, Clock } from "lucide-react";
...
export function ParentLessonsPage() {
    ...
    return (
        <div className="space-y-6 max-w-5xl mx-auto pb-10">
            <div>
                <h2 className="text-2xl font-display font-bold text-foreground">Lesson Materials</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                <Select value={selectedSubject} onValueChange={setSelectedSubject}>
                    ...
                    <SelectContent>
                        {subjects.map(s => (
                            <SelectItem key={s.id} value={s.id}>{s.name} ({s.grade_level})</SelectItem>
                        ))}
                    </SelectContent>
                </Select>
