...
export function AuthLayout({ children, image, title, subtitle, formClassName }: AuthLayoutProps) {
    return (
        <div className="min-h-screen flex w-full">
            ...
            { }
            <div
                className={`w-full lg:w-1/2 flex items-center justify-center p-8 relative ${formClassName || ""}`}
                style={{
